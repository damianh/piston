...
/// <summary>
/// Holds UI-only state that belongs in the view layer, not in <see cref="Piston.Core.PistonState"/>.
/// Instantiated by <see cref="Piston.Views.PistonWindow"/> and mutated by key handlers.
/// </summary>
